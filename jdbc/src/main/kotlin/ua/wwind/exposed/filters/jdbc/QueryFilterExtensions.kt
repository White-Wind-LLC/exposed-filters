...
private enum class JsonInferredType {
    NUMBER,
    BOOLEAN,
    DATE,
    DATETIME,
...
private data class JsonTypedValue(
    val type: JsonInferredType,
    val value: Any
)

private object SqlDateCastColumnType : org.jetbrains.exposed.v1.core.ColumnType<SqlDate>() {
...
private object SqlTimestampCastColumnType : org.jetbrains.exposed.v1.core.ColumnType<SqlTimestamp>() {
...
context(mappersModule: ColumnMappersModule?)
private fun jsonPathPredicateFor(
...
private fun jsonEqTyped(extracted: ExpressionWithColumnType<String>, raw: String, fieldName: String): Op<Boolean> {
...
private fun inferJsonTypedValues(raws: List<String>, fieldName: String, operator: String): List<JsonTypedValue> {
